...
const quickActions = [
  ...
  { label: 'Health Log', helper: 'BP / glucose / weight', icon: 'pulse-outline', target: undefined },
  { label: 'Appointment', helper: 'Doctor / lab visit', icon: 'calendar-outline', target: undefined },
];
